    ...
    case "past":
      {
        return (
          <TextField fullWidth
            onChange={(e)=>{setMyOption({...myOption,years:e.target.value})}}
            label='past years'
    ...
    case "lines":
      {
        return (
          <TextField fullWidth
            onChange={(e)=>{setMyOption({...myOption,count:e.target.value})}}
            label='Line no'
    ...
    case "imageUrl":
      {
        return (
          <React.Fragment>
            <TextField fullWidth
              onChange={(e)=>{setMyOption({...myOption,width:e.target.value})}}
              label='width'
              placeholder="Example: 480" >
            </TextField>
            <Divider sx={{mt: 2}} />
            <TextField fullWidth
              onChange={(e)=>{setMyOption({...myOption,height:e.target.value})}}
              label='height'
              placeholder="Example: 720" >
            </TextField>
            <Divider sx={{mt: 2}} />
            <TextField fullWidth
              onChange={(e)=>{setMyOption({...myOption,category:e.target.value})}}
              label='category'
    ...
    case "sentences":
      {
        return (
          <TextField fullWidth
            onChange={(e)=>{setMyOption({...myOption,sentenceCount:e.target.value})}}
